...
import fragment from './shaders/fragment-video.glsl'
import vertex from './shaders/vertex-video.glsl'
...
window.addEventListener("load", () => {
    ...
    .onReady(() => {
        ...
        if (slidesState.isChanging) {
            ...
            slidesState.transitionTimer = (1 - 0.05) * slidesState.transitionTimer + 0.05 * 60;
